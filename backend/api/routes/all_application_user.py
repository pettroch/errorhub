...
all_application_user_blueprint = Blueprint("all_application_user", __name__)


@all_application_user_blueprint.route("/api/all_application_user", methods=["GET"])
def all_application_user():
    """
    ...
    try:
        ...
        db = Db()
        info = db.get_all_application_user(uid)
